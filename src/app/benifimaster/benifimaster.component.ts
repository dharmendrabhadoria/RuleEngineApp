...
@Component({
  selector: 'app-benifimaster',
  templateUrl: './benifimaster.component.html',
  styleUrls: ['./benifimaster.component.css']
})
export class BenifimasterComponent  implements OnInit {
  ...
  dataSource:any;
    ...
    displayedColumns:string[]=['BenifitID','BenifitName','FieldType','FieldPurpose','FormulaToDriveData','CreatedBy','CreatedDate'];
